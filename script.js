// Exercices avec des fonctions à compléter
...
| Retour    : Périmètre du rectangle ( longueur plus largeur fois 2)
*/
function rectanglePerimetre(L,l){
...
console.log(lengthOfString("Bonjour apprenant"))
...
// Créer une fonction qui retourne la chaine inversée
// swapName("Ada Lovelace") ➞ "ecalevoL adA"
// swapName(“Alan Turing”)➞  “gniruT nalA”
// swapName(“bateau”)➞  “uaetab”
function inversionString(nameLastName) {
...
// checkEnding("apprenants", "boff") ➞ false
